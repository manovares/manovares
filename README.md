...
**`Desenvolvedor FullStack como foco em Back-end`**

Antes de entrar na área de programação, atuei como gestor de tráfego.
Trabalhei em agências, campanhas políticas e projetos de grande alcance — experiências que me ensinaram a pensar com base em dados, métricas e eficiência.
Hoje aplico essa mentalidade no desenvolvimento de software.
Sou estudante da FIAP, cursando Formação Full Stack, com foco em Back-End, onde posso criar estrutura, lógica e soluções escaláveis.
